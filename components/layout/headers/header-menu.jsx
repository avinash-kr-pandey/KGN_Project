            ...
            <ul>
                ...
                <li className='menu-item-has-children'><Link href='#'>About</Link>
                    <ul className='sub-menu'>
                        ...
                        <li><Link href='/services'>Industries We Serve</Link>
                            {/* <ul className='sub-menu'>
                ...
                <li ><Link href='/team-two'>Services</Link>
                    {/* <ul className='sub-menu'>
                ...
                <li className='menu-item-has-children'><Link href='#'>Resouces</Link>
                    <ul className='sub-menu'>
                        <li><Link href='/faq'>FAQs</Link></li>
                        <li><Link href='/portfolio/4-columns'>Media Kit</Link></li>
                        {/* <li><Link href='/blog/impact-of-energy-on-reducing-carbon-footprint'>Blog Details</Link></li> */}
                    </ul>
                </li>
                <li className=''><Link href='/contact'>Contact</Link>
                    {/* <ul className='sub-menu'>
