...
// import SolorBig from "../../../../public/assets/img/home/solor-big.jpg";
import SolorSmall from "../../../../public/assets/home/solor-small.jpg";
    ...
    return (
      <>
        <div className="about__one section-padding pt-0">
          <img
            className="about__one-shape dark-n"
            src={shape1.src}
            alt="shape"
          />
          <img
                ...
                <div className="about__one-left">
                  <div className="about__one-left-image dark_image">
                    ...
                    {/* <div className="about__one-left-image-two">
                      <img src={SolorSmall.src} alt="about-image" />
                    </div> */}
              ...
              <div className="col-xl-6 col-lg-7">
                <div className="about__one-right">
                  <div className="about__one-right-title">
                    ...
                    <p>
                      Our design philosophy is more than aesthetics; it's a
                      dynamic process That delves into the heart of each brand,
                      understanding its story, Values, and aspirations. We
                      believe in the
                    </p>
                  </div>
        ...
        <ModalVideo
          ...
          autoplay
          isOpen={openVideo}
          url="https://drive.google.com/file/d/1RnJfA8ZzSkbufqdAB1BFgezU5xzpLFnc/preview"
