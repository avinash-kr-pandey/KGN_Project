...
import SolorBig from "../../../../public/assets/home/solor-big.jpg";
              ...
              <div className="col-xl-12">
                <div className="choose__us-area">
                  <div className="choose__us-area-title">
                    ...
                    <p>
                      Trust is not just a word for us; it's a commitment woven
                      into the Fabric of our interactions. Clients place their
                      confidence in us Because we consistently
                    </p>
                  </div>
                  ...
                  <div className="choose__us-area-bottom">
                    ...
                    <div className="choose__us-area-bottom-tel sm-mt-25">
                      <h6>
                        ...
                        <Link href="tel:+66 27116724"> +66 27116724</Link>
                      </h6>
                    </div>
                  </div>
                  <div className="choose__us-area-image dark_image">
                    <img src={SolorBig.src} alt="image" className="object-cover" />
                  </div>
                </div>
              </div>
            </div>
